...
function superpwa_get_addons( $slug = false ) {
	...
	$addons = array(
		...
		'visibility_for_superpwa' => array(
							...
							'description'			=> __( 'Visibility allow you to page include or exclude for install/display superpwa', 'super-progressive-web-apps' ),
							'type'					=> 'addon_pro',
							'icon'					=> 'visibility.png',
							'link'					=> 'https://superpwa.com/doc/visibility-for-super-pwa/',
							'more_link'					=> 'https://superpwa.com/doc/visibility-for-super-pwa/',
