...
function superpwa_get_addons( $slug = false ) {
	...
	$addons = array(
		...
		'apple_ipa_app_generator' => array(
							'name'					=> __( 'Apple IPA APP Generator', 'super-progressive-web-apps' ),
							'description'			=> __( 'Easily generate IPA APP of your current PWA website.', 'super-progressive-web-apps' ),
							'type'					=> 'addon_pro',
							'icon'					=> 'apple-ipa.png',
							'link'					=> 'https://superpwa.com/doc/apple-ipa-app-generator-add-on-for-superpwa/',
							'more_link'					=> 'https://superpwa.com/doc/apple-ipa-app-generator-add-on-for-superpwa/',
