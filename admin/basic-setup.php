...
function superpwa_admin_notices() {
	...
	if ( get_transient( 'superpwa_admin_notice_activation' ) ) {
		...
		$superpwa_ui_link_text = ( strpos( $screen->id, 'superpwa' ) === false ) ? '<a href="'.esc_url(admin_url( 'admin.php?page=superpwa' )).'">'.esc_html__( 'Customize your app', 'super-progressive-web-apps' ).' &rarr;</a>' : '';
